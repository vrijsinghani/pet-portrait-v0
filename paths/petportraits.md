...
1. A user-friendly interface for uploading a pet photo and generating an AI portrait
2. Integration with the Replicate API for image generation and fine-tuning
...
10. Use Replicate API for fine tuning flux models and flux image generation 
...
1. Create an easy to use interface for uploading pet photos, captioning them, and generating an AI portraits, storing all images in cloud storage as configured in this codebase
2. Implement API calls to Replicate Flux fine tuning and image generation, handling all required parameters
3. Develop a real-time progress indicator for lora creation, image generation, and image upscaling, updating the user on each step
...
10. A quota system to limit the number of images generated per day
11. A registration system to allow users to sign up and login
12. A profile page to view all generated images
13. Payment system to allow users to purchase additional credits
14. Integration with Stripe for secure payment processing
15. A homepage with a hero banner, featured images, and a short description of the app that makes it clear what it does and shows a few examples of uploaded images converted into portraits
16. Social login options using Google, Facebook, and Twitter
17. An admin page to manage uploaded images and user accounts
18. An admin page to manage API costs in total and by user
19. An admin page to manage the homepage featured images
20. An admin page to manage the app settings
21. An admin page to manage the app pricing
